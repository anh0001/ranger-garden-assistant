...
**IMPORTANT: Follow these rules strictly when working with this codebase:**

- **Do NOT create .md files** - Only modify existing documentation files unless explicitly asked otherwise
- **Do NOT create test files, example programs, or demo scripts** - Only modify existing test files when necessary
- **Only modify existing source files unless explicitly asked otherwise** - Prefer editing over creating new files
...
**IMPORTANT**: When working with Nav2 parameters or navigation issues, ALWAYS reference:
...
**ALWAYS consult Nav2 Tuning Guide (https://docs.nav2.org/tuning/index.html) before modifying navigation parameters.**
...
- **Nav2 Documentation**:
  ...
  - Tuning Guide: https://docs.nav2.org/tuning/index.html (consult when adjusting navigation parameters)
